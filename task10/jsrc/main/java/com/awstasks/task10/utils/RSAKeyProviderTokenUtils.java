...
public class RSAKeyProviderTokenUtils implements RSAKeyProvider {
    private final URL aws_kid_store_url;
    private final JwkProvider provider;

    public RSAKeyProviderTokenUtils(String region, String user_pool_id) {
        String url = String.format("https://cognito-idp.%s.amazonaws.com/%s/.well-known/jwks.json", region, user_pool_id);
        try {
